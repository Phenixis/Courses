...
import Me3_4 from "@/app/public/me_3-4_right.png";
...
export default async function Page() {
    return (
        <div className="flex items-stretch justify-center">
            {/* Make this wrapper stretch to the flex line height so the Image with `fill` has a height */}
            ...
            <section className="flex-1 max-w-3xl px-4 sm:px-6 lg:px-8 py-8">
